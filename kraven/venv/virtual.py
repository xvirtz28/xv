...
print('Loading your AI personal assistant - Kraven')
...
def takeCommand():
    ...
    with sr.Microphone() as source:
        print("Awaiting for your command...")
...
speak("Loading your AI personal assistant Kraven")
wishMe()
...
if __name__=='__main__':
    ...
    while True:
        speak("Awaiting for your command!")
        statement = takeCommand().lower()
        if statement==0:
            continue

        if "good bye" in statement or "ok bye" in statement or "stop" in statement:
            speak('your personal assistant Kraven is shutting down,Good bye Master Basti!')
            print('your personal assistant Kraven is shutting down,Good bye Master Basti!')
            break
